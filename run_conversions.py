...
if_5070_path_none_with_0 = r"intermediate_data/tif_5070_none_with_0.tif"
template_path = r"template_data/dust_emissions_05.20210906.nc"
scaling_factor = 0.1

tif_to_nc(fulres_4326_path, lowres_4326_path, output_nc_path, input_tif_5070_path, template_path, tif_5070_path_none_with_0, scaling_factor=scaling_factor)