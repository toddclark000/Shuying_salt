...
def tif_to_nc(fulres_4326_path, lowres_4326_path, output_nc_path, tif_5070_path, tif_5070_path_none_with_0, template_path,scaling_factor = 0.01):
    """
    ...
    transform_5070_to_4326(tif_5070_path_none_with_0, fulres_4326_path)
